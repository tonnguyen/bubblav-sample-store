      ...
      <section className="bg-white py-16 px-16">
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="grid grid-cols-2 gap-8">
            <div className="border border-light rounded-lg p-8">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-light">
                  ...
                  <th className="text-left py-3 text-brand font-semibold">Standard Delivery</th>
                  <th className="text-left py-3 text-brand font-semibold">Express Delivery</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-light">
      ...
      <section className="bg-white py-16 px-16 border-t border-light">
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="w-[320px] h-[200px] bg-offset rounded-lg flex items-center justify-center">

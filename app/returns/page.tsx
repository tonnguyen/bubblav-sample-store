import { RotateCcw, Package, Shield, Clock, CheckCircle } from 'lucide-react';
  ...
  return (
    <>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-3 text-muted text-sm">
                  <CheckCircle className="w-4 h-4 text-accent" strokeWidth={2} />
      ...
      <section className="bg-offset py-16 px-16">
        <div className="max-w-[1440px] mx-auto">
          <div className="flex items-center gap-3 mb-8">
            <RotateCcw className="w-6 h-6 text-accent" strokeWidth={1.5} />
            <h2 className="font-newsreader text-[32px] font-medium leading-[1.1] text-brand">
          ...
          <div className="bg-white border border-light rounded-lg p-8">
            ...
            <ol className="space-y-4">
              <li className="flex gap-4">
                ...
                <div>
                  <p className="text-brand text-sm font-semibold mb-1">Initiate Your Return</p>
                  <p className="text-muted text-sm">Log into your account or visit Returns Portal. Enter your order number and email. Select the items you want to return. Choose refund or exchange.</p>
                </div>
              </li>
              <li className="flex gap-4">
                <span className="w-8 h-8 bg-accent rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <p className="text-brand text-sm font-semibold mb-1">Print Your Return Label</p>
                  <p className="text-muted text-sm">Download and print the prepaid return label. Attach it to your package.</p>
                </div>
              </li>
              <li className="flex gap-4">
                <span className="w-8 h-8 bg-accent rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <p className="text-brand text-sm font-semibold mb-1">Drop Off Your Package</p>
                  <p className="text-muted text-sm">Take your package to any PostNord service point. Keep your receipt as proof of return.</p>
                </div>
              </li>
              <li className="flex gap-4">
                <span className="w-8 h-8 bg-accent rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <p className="text-brand text-sm font-semibold mb-1">Receive Your Refund</p>
                  <p className="text-muted text-sm">Refunds are processed within 5-7 business days after we receive your return. You'll receive an email confirmation when processed.</p>
                </div>
              </li>
            </ol>
          </div>

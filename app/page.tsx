    ...
    <>
      ...
      <section className="bg-white px-4 sm:px-8 lg:px-16">
        <div className="max-w-[1440px] mx-auto">
          <div className="flex flex-col-reverse md:flex-row md:h-[600px]">
            {/* Left Content */}
            <div className="flex-1 flex flex-col justify-center py-10 md:py-0 md:pr-12">
              ...
              {/* Headline */}
              <h1 className="font-newsreader text-4xl sm:text-5xl lg:text-[56px] font-medium leading-[1.1] text-brand mb-6">
            ...
            {/* Right Image */}
            <div className="w-full md:w-[520px] h-[300px] sm:h-[400px] md:h-full relative">
              <Image
      ...
      {/* Features Strip */}
      <section className="bg-offset border-y border-light py-4 sm:py-0 sm:h-20">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-16 h-full">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-0 sm:flex sm:justify-around sm:items-center h-full py-4 sm:py-0">
            <div className="flex items-center gap-3">
              <Truck className="w-5 h-5 text-accent flex-shrink-0" strokeWidth={1.5} />
              <span className="text-brand text-sm font-medium">Free Shipping</span>
            </div>
            <div className="flex items-center gap-3">
              <RefreshCw className="w-5 h-5 text-accent flex-shrink-0" strokeWidth={1.5} />
              <span className="text-brand text-sm font-medium">Easy Returns</span>
            </div>
            <div className="flex items-center gap-3">
              <Shield className="w-5 h-5 text-accent flex-shrink-0" strokeWidth={1.5} />
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-8 lg:px-16">
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="text-center mb-10 sm:mb-12">
            ...
            <h2 className="font-newsreader text-3xl sm:text-[40px] font-medium leading-[1.1] text-brand mb-3">
              Featured Collections
            </h2>
      ...
      {/* Brand Promise */}
      <section className="bg-white border-y border-light py-16 sm:py-24 px-4 sm:px-8 lg:px-16">
        <div className="max-w-[1440px] mx-auto">
          {/* Header */}
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h2 className="font-newsreader text-3xl sm:text-[40px] font-medium leading-[1.1] text-brand mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {[
              ...
              <div key={i} className="border border-light rounded-lg p-6 sm:p-8">
                ...
                <p className="text-muted-light text-sm leading-[1.5]" dangerouslySetInnerHTML={{ __html: item.desc }} />
              </div>
            ))}
          </div>
        </div>

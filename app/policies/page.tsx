  ...
  return (
    <>
      ...
      <section className="bg-white py-12 sm:py-16 px-4 sm:px-8 lg:px-16">
        <div className="max-w-[900px] mx-auto">
          <div className="flex items-center gap-3 mb-6">
            <FileText className="w-6 h-6 text-accent flex-shrink-0" strokeWidth={1.5} />
      ...
      <section className="bg-white py-12 sm:py-16 px-4 sm:px-8 lg:px-16">
        <div className="max-w-[900px] mx-auto">
          <div className="flex items-center gap-3 mb-6">
            <Cookie className="w-6 h-6 text-accent flex-shrink-0" strokeWidth={1.5} />
            <h2 className="font-newsreader text-2xl sm:text-[32px] font-medium leading-[1.1] text-brand">
              Cookie Policy
            </h2>
          </div>
        ...
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div className="flex items-start gap-4">
              <CreditCard className="w-6 h-6 text-accent mt-1 flex-shrink-0" strokeWidth={1.5} />
              <div>
            ...
            <div className="flex items-start gap-4">
              <FileText className="w-6 h-6 text-accent mt-1 flex-shrink-0" strokeWidth={1.5} />
              <div>
      ...
      <section className="bg-white py-12 sm:py-16 px-4 sm:px-8 lg:px-16 border-t border-light">
        <div className="max-w-[1440px] mx-auto">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            ...
            <Link href="/contact" className="bg-brand text-white px-6 py-3 rounded text-sm font-medium whitespace-nowrap">
              Contact Us
            </Link>
          </div>
        </div>

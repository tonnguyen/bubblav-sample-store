...
export function Footer() {
  return (
    <footer className="bg-brand text-white py-12 sm:py-16 lg:py-20 px-4 sm:px-8 lg:px-16">
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="border-t border-white/20 pt-8 mb-8">
          ...
          <p className="text-muted-light text-sm leading-[1.5] mb-4 max-w-sm">
          ...
          <div className="flex gap-2 max-w-sm">
            <input
              ...
              className="flex-1 bg-white/10 border border-white/20 rounded px-4 py-2 text-sm text-white placeholder:text-muted-light focus:outline-none focus:border-white/40 min-w-0"
            />
            <button className="bg-white text-brand px-4 py-2 rounded text-sm font-medium hover:bg-white/90 transition-colors whitespace-nowrap">
              Subscribe
            </button>
          </div>
        </div>
